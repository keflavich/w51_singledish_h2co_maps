...
glon,glat = np.array(zip(*[(rd.galactic.lonangle.degree,rd.galactic.latangle.degree) for rd in radec]))


for suffix,extrastr in ((".fits",""), ("_filtered.fits", "filtered")):
    parcubefile = fits.open('W51_taucube_fit_parcube_try10'+suffix)
