...
is available at \url{https://github.com/keflavich/gbtpy}.  The data reduction
...
XXXX continue from here XXXX


\Figure{figures/continuum_rrl_comparisongrid.pdf}
{Plots of the 5 GHz and 15 GHz }
...
gridded into map cubes using the \texttt{makecube} routines in \texttt{gbtpy}.

The GBT data was processed using exclusively custom-made scripts stored in
\texttt{gbtpy}.  The KFPA pipeline
