...
\Figure{figures/spectralfits_70kmscloud_aperture_ap6_modelcomparison_residuals.pdf}
...
The mass-weighted mean density ranges from $\sim$1.5\ee{4} to 5.6\ee{4} \percc, with
the lowest mean density corresponding to the highest column density toward the
center.

\subsection{The edge of W51 C}
W51 C is a supernova remnant that spatially overlaps with the W51 B star
forming region.  There are clumps aligned along the 68 \kms filamentary cloud
with very high CO and HI velocities \citep{Koo1997b,Koo1997c,Brogan2013a}.

The clumps at $\sim68$ \kms are lower density ($n<1.5\ee{4}$ \percc) and in the
background of the HII region.  These clumps are associated with the supernova
interaction region.  The $62 \kms$ have densities a few times higher,
$n\sim4\ee{4}$ \percc, and are clearly in the foreground of the continuum
emission because their absorption depths are $\sim2.5$ K, which cannot occur
for absorption against the CMB.

We are therefore seeing molecular gas both in front of and behind the
supernova.  This geometry can be readily confirmed by looking for molecular absorption
at much lower frequencies where the SN synchrotron emission dominates over the
\hii region free-free emission, i.e. the 335 and 71 MHz \para lines.
...
as part of the G49.4-0.3 complex.
