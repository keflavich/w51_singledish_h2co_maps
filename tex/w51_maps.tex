...
The agreement \todo{was excellent in a previous version, and now shows the 
Arecibo data yielding too-bright emission by a factor $\sim1.4$, which hints
that maybe there's a double-$\eta_{MB}$ correction happening?  This is very bad.}
...
should be rapidly forming stars.  \todo{Unclosed contours should probably be
ignored or removed.}}
