...
(2) Ongoing high-mass star formation is correlated with $n\gtrsim5\ee{4}$ gas.
Gas with $n>10^4 \percc$}
...
H77$\alpha$, and two others that were not reduced.}
...
surface density.  The two converge at the highest surface densities. }
}
