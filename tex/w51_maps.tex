...
\todo{Density maps have proved very difficult to make in any sort of robust and
sensible way; they are frequently systematically wrong in different ways.  I
think I have arrived at a reasonable compromise approach that will take a few
days to complete, though.}

\todo{The plan is to take the peak density map and use contours at a few different
levels (probably 5000, 10000, 20000, 50000 \percc, approximately) and calculate the
total mass (from Herschel) within each contour.  We will then be able to present
the `dense gas mass fraction' of the whole W51 region.}
