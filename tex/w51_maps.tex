...
fraction (DGMF) over the range $10^4$ $\percc< n(\hh) < 10^6$ \percc.  The DGMF
in W51 Main is high, $f\gtrsim70\%$ above $n>10^4$ \percc, indicating that
...
\begin{enumerate}
    ...
    \item Growing (dilating) the included mask region by 1 pixel in all
        directions
    \item Selecting all voxels with $>=5$ neighbors marked as `included' by the
