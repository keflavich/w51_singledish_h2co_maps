...
fraction (DGMF) over the range $10^4$ $\percc< n(\hh) < 10^6$ \percc.  We measure a
high DGMF in W51 Main, indicating that nearly all of its mass should form stars,
and a very low DGMF in W51 B, suggesting that its star-forming lifetime has come
to an end and it is being disrupted by stellar feedback.
...
\citep[e.g.][]{Lada2010a,Krumholz2008a,Kauffmann2010a}, and therefore is expect
