...
The data set has been made public at \todo{location}.
...
b\sim-0.3$, very near the Galactic midplane\footnote{The midplane at $d=5.1$
kpc is offset approximately -0.22 to -0.33 degrees from $b=0$ depending on our
solar system's height above the midplane, $Z_\sol = 20$ pc or 30 pc,
respectively \citep{Reed2006a,Joshi2007a}.} at a distance of 5.1 kpc
\citep{Sato2010a}.  It is a well-known and
thoroughly studied collection of clouds massing $M>10^6 \msun$
...
using a main-beam efficiency as a function of zenith angle ($za$): $$\eta_{MB}(za) =
0.491544 + 0.00580397 za - 0.000341992 za^2$$
...
\url{https://github.com/keflavich/w51_singledish_h2co_maps}, \todo{with a snapshot of the 
publication version available as a tarball from figshare \url{}}.
