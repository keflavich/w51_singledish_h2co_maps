...
\label{sec:contrrldata} describes the RRL and continuum data.  Appendix
\label{sec:geometry} describes details of individual regions, with a focus on
...
% DONE - S/N in the continuum, tau=1/5 
...
``mini-starburst".  In this scenario, the W51 B/C region, with its mature HII
...
\Figure{figures/StarFormingMassMap_Kang2009ClassIYSOs}
...
densities.  The W51 protocluster has the majority of its mass in gas with
density $n(\hh)>5\ee{4}$ \percc.  The rest of the cloud has a small dense gas
fraction, with $f(n>1\ee{4}~\percc) \sim 10\%$.  The W51 B cloud therefore
appears to be at the end of its star-forming lifetime, while W51 Main/A will
continue to form stars efficiently in the future.
