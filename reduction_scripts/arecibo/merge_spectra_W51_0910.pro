...
savepath = '/Users/adam/observations/arecibo/20120910/'

; there is RFI in this band
flist = get_scanlist(0,136,obsdate='20120910',machine='eta',bsg='b5s1g1')
accum_map,flist,savefile=savepath+'W51_h108a_spectra_0910.fits',$
...
accum_map,flist,savefile=savepath+'W51_h2coW_spectra_0910.fits',$
    velocities=[-10,2,8,43,75,115],obsdate='20120910',machine='eta',$
    line='h2coW',percentile=99,/doplot,/do_mask_line

; this one was tuned incorrectly
flist = get_scanlist(0,136,obsdate='20120910',machine='eta',bsg='b0s1g0')
accum_map,flist,savefile=savepath+'W51_h2co_spectra_0910.fits',$
    velocities=[-10,2,8,43,75,115],obsdate='20120910',machine='eta',line='h2co',percentile=99,/doplot,/do_mask_line

flist = get_scanlist(0,136,obsdate='20120910',machine='eta',bsg='b2s1g1')
accum_map,flist,savefile=savepath+'W51_h213coW_spectra_0910.fits',obsdate='20120910',machine='eta',line='h213coW',percentile=10,/doplot
flist = get_scanlist(0,136,obsdate='20120910',machine='eta',bsg='b1s1g0')
accum_map,flist,savefile=savepath+'W51_h213co_spectra_0910.fits',obsdate='20120910',machine='eta',line='h213co',percentile=10,/doplot

; flist = get_scanlist(99,4,obsdate='20120910',machine='eta',bsg='b3s1g0')
; accum_map,flist,savefile=savepath+'W51_h2coW_spectra_0910.fits',velocities=[-10,100],obsdate='20120910',machine='eta',line='h2coW',/debug,percentile=10
