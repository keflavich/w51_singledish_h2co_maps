...
tau = 0.02
refpairs = [[10,41],[42,73],[74,105]]
mapnames = ['W51','W51','W51']

filename = '/Users/adam/observations/gbt/AGBT10B_019_16/AGBT10B_019_16.raw.acs.fits'
try:
...
savefig('/Users/adam/observations/gbt/AGBT10B_019_16/AGBT10B_019_16_continuum_nolimits.png')
gca().set_ylim(1,5)
savefig('/Users/adam/observations/gbt/AGBT10B_019_16/AGBT10B_019_16_continuum.png')

for (ref1,ref2),mapname in zip(refpairs,mapnames):
    scanrange = [ref1+1,ref2-1]
    outpath = '/Users/adam/observations/gbt/%smap/' % mapname
    calibrate_map_scans.calibrate_cube_data('/Users/adam/observations/gbt/AGBT10B_019_16/AGBT10B_019_16.raw.acs.fits',
        outpath+'Session16_%ito%i_A13_F1.fits' %
    ...
    calibrate_map_scans.calibrate_cube_data('/Users/adam/observations/gbt/AGBT10B_019_16/AGBT10B_019_16.raw.acs.fits',
        outpath+'Session16_%ito%i_C29_F2.fits' %
        (ref1,ref2),scanrange=scanrange,refscan1=ref1,refscan2=ref2, feednum=2,
